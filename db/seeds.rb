...
Booking.create(trip_id: 1, passenger_id:1, departure: Trip.find(1).departure, status: "pending")
Booking.create(trip_id: 4, passenger_id:1, departure: Trip.find(1).departure, status: "pending")
